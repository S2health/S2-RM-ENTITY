...
h|*0..1*
|*comms_addresses*: `List<<<_comms_address_use_class,Comms_address_use>>>`
a|Contacts for this party.

h|*0..1*
|*identifiers*: `List<<<_id_use_class,Id_use>>>`
...
h|*0..1*
|*location_addresses*: `List<<<_location_address_use_class,Location_address_use>>>`
