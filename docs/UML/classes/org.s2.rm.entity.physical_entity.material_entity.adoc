...
h|*0..1*
|*individual_attributes*: `List<link:/releases/S2-RM-BASE/{base_release}/docs/patterns.html#_node_class[Node^]>`
...
h|*0..1*
|*lot_information*: `List<link:/releases/S2-RM-BASE/{base_release}/docs/patterns.html#_node_class[Node^]>`
a|Information relating to a manufacturing or purchase lot, for volume procured items.

h|*0..1*
|*use_details*: `List<link:/releases/S2-RM-BASE/{base_release}/docs/patterns.html#_node_class[Node^]>`
a|Details relating to use, location, maintenance.

h|*0..1*
|*other_identifiers*: `List<link:/releases/S2-RM-BASE/{base_release}/docs/patterns.html#_node_class[Node^]>`
